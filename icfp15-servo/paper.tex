\documentclass[preprint,onecolumn]{../common/sigplanconf}

\usepackage[textwidth=4in, left=2in, right=2in, bottom=0in]{geometry}
...
\authorinfo{%
  ...
  David Herman \and Josh Matthews \\
  Keegan McAllister \and Jack Moffitt \\
  Simon Sapin
}{%
  Mozilla Research}{%
  \{banderson,larsberg,dherman,jdm,\\kmcallister,jack,simonsapin\}@mozilla.com}
\authorinfo{%
  Manish Goregaokar
